---
title: "CNB Platform Differences"
...
```{r making/saving plots, include=F}
Pall_rec <- list()                                         # [P]lots for [all] and [rec]ent dates
cntr <- 1
...
The data used for this project comes from bblrepo1 (/data/secure/bit_dwh/cnb/cnb_merged_webcnp_surveys_allbblprjcts_longform20220406.csv), keeping only the participants with BBLIDs. Many of the participants in this dataset were administered the CNB multiple times. To make things simple, we only kept their most recent data point. If a BBLID's last CNB data point was from a virtual/remote assessment, this data was kept and they were assigned as a "Remote" participant. If a BBLID's last CNB data point was from an in-person assessment, this data was kept and they were assigned as an "In person" participant. 

The analyses shown here include plots of the sex-regressed and age-matched In-person vs Remote participant accuracy and reaction time plotted against age, in addition to overall and age-binned t-tests and equivalence tests. These analyses were done for all time points as well as all timepoints from 2016 to the present.

*CNB tasks examined in this document*
* ADT36 A, ADT36 B, ADT60 A
* AIM
* CPF A, CPF B
* CPW A, KCPW A
* DIGSYM
* EDISC
* ER40 A, ER40 C, ER40 D
* GNG150
* KDDISC
* KRDISC
* KSPVRT A, KSPVRT B, KSPVRT D
* MEDF36 A, MEDF36 B, MEDF60 A
* MPRACT
* PCET A, PCET B, SPCET A
* PMAT24 A, PMAT24 B, PMAT18 A
* SCTAP
* SLNB2 90
* SPCPTNL
* SVOLT A
* VSPLOT12, VSPLOT15, VSPLOT24
