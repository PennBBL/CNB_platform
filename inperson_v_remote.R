...
dat <- read_csv("cnb_merged_20220201.csv")    # digsym, GNG, AIM, + itemwise (iw) DDISC, iw RDISC, iw EDISC
...
cpf_gg1 <- ggplot(new,aes(x=age)) +
  ...
  labs(x = "Age",
       y = "Total Correct",
       title = "CPF Accuracy (as Total Correct) across age, sex and platform") +
  scale_x_continuous(limits = c(5,105))

ggsave("plots/CPF_acc.pdf")
...
cpt_gg1 <- ggplot(new,aes(x=age)) +
  ...
  labs(x = "Age",
       ...
       title = "CPT Accuracy (as Percent true Positive) across age, sex and platform") +
  scale_x_continuous(limits = c(5,105))

ggsave("plots/CPT_acc.pdf")
...
cpw_gg1 <- ggplot(new,aes(x=age)) +
  ...
  labs(x = "Age",
       y = "Total Correct",
       title = "CPW Accuracy (as Total Correct) across age, sex and platform") +
  scale_x_continuous(limits = c(5,105))

ggsave("plots/CPW_acc.pdf")
...
er40_gg1 <- ggplot(new,aes(x=age)) +
  ...
  labs(x = "Age",
       y = "Total Correct",
       title = "ER40 Accuracy (as Total Correct) across age, sex and platform") +
  scale_x_continuous(limits = c(5,105))

ggsave("plots/ER40_acc.pdf")
...
lnb_gg1 <- ggplot(new,aes(x=age)) +
  ...
  labs(x = "Age",
       y = "Total Correct",
       title = "LNB Accuracy (as Total Correct) across age, sex and platform") +
  scale_x_continuous(limits = c(5,105))

ggsave("plots/LNB_acc.pdf")
...
medf_gg1 <- ggplot(new,aes(x=age)) +
  ...
  labs(x = "Age",
       y = "Percent Correct",
       title = "MEDF Accuracy (as Percent Correct) across age, sex and platform") +
  scale_x_continuous(limits = c(5,105))

ggsave("plots/MEDF_acc.pdf")
...
pcet_gg1.1 <- ggplot(new,aes(x=age)) +
  scale_color_manual(values=colors) +
  geom_point(aes(y=female_inp, color=paste("Female In-person, n =",nnn[1]))) +
  geom_point(aes(y=female_rem, color=paste("Female Remote, n =",nnn[2]))) +
  geom_point(aes(y=male_inp, color=paste("Male In-person, n =",nnn[3]))) +
  ...
  labs(x = "Age",
       ...
       title = "PCET Accuracy (as Catergories Achieved) across age, sex and platform") +
  scale_x_continuous(limits = c(5,105))

ggsave("plots/PCET_acc1.pdf")
...
pcet_gg1.2 <- ggplot(new,aes(x=age)) +
  scale_color_manual(values=colors) +
  geom_point(aes(y=female_inp, color=paste("Female In-person, n =",nnn[1]))) +
  geom_point(aes(y=female_rem, color=paste("Female Remote, n =",nnn[2]))) +
  geom_point(aes(y=male_inp, color=paste("Male In-person, n =",nnn[3]))) +
  ...
  labs(x = "Age",
       y = "Accuracy2",
       title = "PCET Accuracy (as Accuracy2) across age, sex and platform") +
  scale_x_continuous(limits = c(5,105))

ggsave("plots/PCET_acc2.pdf")
...
plot_gg1 <- ggplot(new,aes(x=age)) +
  ...
  labs(x = "Age",
       y = "Percent Correct",
       title = "PLOT Accuracy (as Percent Correct) across age, sex and platform") +
  scale_x_continuous(limits = c(5,105))

ggsave("plots/PLOT_acc.pdf")
...
pmat_gg1 <- ggplot(new,aes(x=age)) +
  ...
  labs(x = "Age",
       y = "Percent Correct",
       title = "PMAT Accuracy (as Percent Correct) across age, sex and platform") +
  scale_x_continuous(limits = c(5,105))

ggsave("plots/PMAT_acc.pdf")
...
volt_gg1 <- ggplot(new,aes(x=age)) +
  ...
  labs(x = "Age",
       y = "Total Correct",
       title = "VOLT Accuracy (as Total Correct) across age, sex and platform") +
  scale_x_continuous(limits = c(5,105))

ggsave("plots/VOLT_acc.pdf")
...
#   labs(x = "Age",
#        y = "Percent Correct",
#        title = "AIM Accuracy (as Total Correct) across age, sex and platform") +
#   scale_x_continuous(limits = c(5,105))
# 
# ggsave("plots/AIM_acc.pdf")
...
digsym_gg1 <- ggplot(new,aes(x=age)) +
  scale_color_manual(values=colors) +
  geom_point(aes(y=female_inp, color=paste("Female In-person, n =",nnn[1]))) +
  geom_point(aes(y=female_rem, color=paste("Female Remote, n =",nnn[2]))) +
  geom_point(aes(y=male_inp, color=paste("Male In-person, n =",nnn[3]))) +
  ...
  labs(x = "Age",
       y = "Percent Correct",
       title = "DIGSYM Accuracy (as Total Correct) across age, sex and platform") +
  scale_x_continuous(limits = c(5,105))

ggsave("plots/DIGSYM_acc.pdf")
...
dsm_gg1 <- ggplot(new,aes(x=age)) +
  ...
  labs(x = "Age",
       y = "Percent Correct",
       title = "DIGSYM (memory) Accuracy (as Total Correct) across age, sex and platform") +
  scale_x_continuous(limits = c(5,105))

ggsave("plots/DIGSYMmem_acc.pdf")
...
gng_gg1 <- ggplot(new,aes(x=age)) +
  ...
  labs(x = "Age",
       y = "Percent Correct",
       title = "GNG Accuracy (as Total Correct) across age, sex and platform") +
  scale_x_continuous(limits = c(5,105))

ggsave("plots/GNG_acc.pdf")
